...
public class IrtCatApiController {
    ...
    public ResponseEntity<ApiResponse<WordExam>> startExam() {
    ...
    public ResponseEntity<ApiResponse<SubmitResult>> submitAnswer(
    ...
    public ResponseEntity<ApiResponse<WordExamDetail>> getCurrentQuestion(
            @ApiParam(value = "시험 ID", required = true)
            @PathVariable Long examId) {
    ...
    public ResponseEntity<ApiResponse<WordExam>> getExamResult(
            @ApiParam(value = "시험 ID", required = true)
            @PathVariable Long examId) {
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> initializeDifficulty() {
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> runCalibration() {
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> calibrateSingleItem(
