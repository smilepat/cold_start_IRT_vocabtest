...
import ClozeThemeList from './components/Cloze/ClozeThemeList';
import ClozePassage from './components/Cloze/ClozePassage';
			...
			<ResponsiveView>
				<Router>
					<Switch>
						...
						<Route
							path='/learning'
							render={() => <LearningMode examId={examId} />}
						/>
						<Route path='/cloze' exact component={ClozeThemeList} />
						<Route path='/cloze/theme/:themeId' component={ClozePassage} />
